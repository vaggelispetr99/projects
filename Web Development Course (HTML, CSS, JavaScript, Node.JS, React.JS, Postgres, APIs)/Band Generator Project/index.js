...
app.post("/submit", (req, res) => {
  ...
  var adjLengthPicker = Math.floor(Math.random() * adj.length);
  var adjSel = adj[adjLengthPicker];
  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
  var nounLengthPicker = Math.floor(Math.random() * noun.length);
  var nounSel = noun[nounLengthPicker];
  //3. Test to make sure that the random words display in the h1 element in index.ejs
  var adjNounSel = adjSel + " " + nounSel;
  res.render("index.ejs", {adjNounSel: adjNounSel, year: year});
});

...
int main(){
    ...
    cout << "Graduate Student name: " << grad_student.get_name() << " Graduate Student GPA: " << grad_student.gpa << " Graduate Student major: " << grad_student.get_major() << " Graduate Student scholaship: " << grad_student.has_scholarship() << endl;

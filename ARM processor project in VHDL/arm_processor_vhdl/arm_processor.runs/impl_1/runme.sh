...
HD_PWD='C:/Users/User/arm_processor/arm_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arm.tcl -notrace

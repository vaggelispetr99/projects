...
HD_PWD='C:/Users/User/arm_processor/arm_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arm.tcl

...
#define MAX_RECORDS_IN_BLOCK ((int)((BF_BLOCK_SIZE - sizeof(HT_block_info))/sizeof(Record)))
#define METADATA_POSITION ((int)((BF_BLOCK_SIZE/sizeof(HT_block_info))-1))


typedef struct {
    int file_descriptor, last_block_id, buckets_num;
    int *hash_table;
    BF_Block *info_block;
} HT_info;
